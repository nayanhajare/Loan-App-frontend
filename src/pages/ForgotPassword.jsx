...
const ForgotPassword = () => {
  ...
  return (
    <Box maxWidth={400} mx="auto" mt={8} p={3} boxShadow={4} borderRadius={3} sx={{ bgcolor: 'background.paper' }}>
      <Typography variant="h5" mb={2} color="text.primary">Forgot Password</Typography>
      <form onSubmit={handleSubmit}>
        <TextField label="Email" fullWidth margin="normal" value={email} onChange={e => setEmail(e.target.value)} required variant="outlined" />
